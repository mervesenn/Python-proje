...
for kyolu, kisimleri, disimleri in dosyalar:
    for i in disimleri:
        if i.endswith(".txt"):
            dosyayazdir(kyolu + i,"C://Users/Hp/Desktop/txtdosyaları.txt")
        elif i.endswith(".mp4"):
            dosyayazdir(kyolu + i,"C://Users/Hp/Desktop/mp4dosyaları.txt")
        elif i.endswith(".pdf"):
            dosyayazdir(kyolu + i,"C://Users/Hp/Desktop/pdfdosyaları.txt")
